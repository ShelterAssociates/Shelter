...
class avni_sync():
    ...
    def create_registrationdata_url(self,subject_type):  # checked
        ...
        print(f"Houshold path is {household_path}")
    ...
    def registrtation_data(self, HH_data):  # checked
        ...
        try:
            ...
            #print(f"Slum name is {slum_name}  , Slum id is {slum_id} and city id is {city_id}")
            ...
            if not check_record:
                ...
                if 'group_og5bx85/Type_of_survey' not in final_rhs_data:
                    ...
                    # Assume final_rhs_data is your processed dict
                    # occupancy = final_rhs_data.get('Type_of_structure_occupancy')

                    # if occupancy is None:
                    #     # This record is missing the key, print full data
                    #     print("Missing 'Type_of_structure_occupancy'. Full RHS data:")
                    #     print(final_rhs_data)
                    # else:
                    #     # Count based on occupancy type
                    #     if occupancy == "Occupied house":
                    #         occupied_count += 1
                    #         print(f"Final RHS data is {final_rhs_data}")
                    #     elif occupancy == "Unoccupied house":
                    #         unoccupied_count += 1
                    #     elif occupancy == "Religious Structure":
                    #         religious_count += 1
                    #     elif occupancy == "Locked house":
                    #         locked_count += 1
    ...
    def SaveRhsData(self,subject_type):  # checked
        ...
        #json_file_path = '/home/shelter/rhs_data_Structure_06_09_2025(MLG_BTH).json'
