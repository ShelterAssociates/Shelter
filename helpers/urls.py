...
urlpatterns = [
    ...
    url(r'^manage/photo-type-items/$', manage_photo_type_items, name='manage_photo_type_items'),
    url(r'^manage/photo-type-items/toggle/$', manage_toggle_photo_type_item, name='manage_toggle_photo_type_item'),
    url(r'^manage/photo-type-items/add/$', manage_add_photo_type_item, name='manage_add_photo_type_item'),
