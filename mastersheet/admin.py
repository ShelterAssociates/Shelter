...
from .models import *
from .forms import (
    VendorHouseholdInvoiceDetailForm,
    SBMUploadForm,
    ToiletConstructionForm,
    CommunityMobilizationForm,
)
import datetime
...
class InvoiceItemsInline(admin.TabularInline):
    ...
    def copy_above(self, obj):
        return format_html(
            '<button type="button" onclick = "copy_this(this)" class="btn-sm glyphicon glyphicon-copy" ></button>'
        )

    copy_above.allow_tags = True

    def save_formset(self, request, form, formset, change):
        super(InvoiceItemsInline, self).save_formset(
...
admin.site.register(
    CommunityMobilizationActivityAttendance,
    CommunityMobilizationActivityAttendanceAdmin,
)
