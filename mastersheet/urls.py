...
urlpatterns = [
    url(
        r"^report_table_cm_activity_count/$",
        report_table_cm_activity_count,
        name="report_table_cm_activity_count",
    ),
    url(r"^report_table_cm/$", report_table_cm, name="report_table_cm"),
    url(
        r"^report_table/$", give_report_table_numbers, name="give_report_table_numbers"
    ),
    url(
        r"^report_table_accounts/$",
        give_report_table_numbers_accounts,
        name="give_report_table_numbers_accounts",
    ),
