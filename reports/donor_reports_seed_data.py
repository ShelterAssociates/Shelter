from reports.models import Deliverable, WorkProgressParameter, BeneficiaryIndicator
...
for name, description in deliverables:
    try:
        ...
        obj = Deliverable(name=name, description=description)
        obj.save()
...
for name, unit, description in work_progress_parameters:
    try:
        ...
        obj = WorkProgressParameter(name=name, unit=unit, description=description)
        obj.save()
...
for name, unit, description in beneficiary_indicators:
    try:
        ...
        obj = BeneficiaryIndicator(name=name, unit=unit, description=description)
        obj.save()
