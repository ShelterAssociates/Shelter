...
class BeneficiaryIndicator(models.Model):
    ...
    icon = models.ImageField(
        upload_to="beneficiary_indicator_icons/", blank=True, null=True
    )
...
class SponsorProjectReportDetails(models.Model):
    ...
    sponsor_project = models.ForeignKey(
        SponsorProject, on_delete=models.CASCADE, related_name="project_reports"
    )

    project_locations = models.ManyToManyField(
        Slum, related_name="sponsor_project_reports"
    )
    ...
    deliverables = models.ManyToManyField(
        Deliverable, through="SponsorProjectDeliverable", related_name="project_reports"
    )
...
class SponsorProjectMonthlyWorkProgress(models.Model):
    ...
    location = models.ForeignKey(
        Slum, on_delete=models.CASCADE, related_name="monthly_work_progress"
    )

    parameter = models.ForeignKey(WorkProgressParameter, on_delete=models.CASCADE)
...
class SponsorProjectMonthlyBeneficiaryValue(models.Model):
    ...
    indicator = models.ForeignKey(BeneficiaryIndicator, on_delete=models.CASCADE)
