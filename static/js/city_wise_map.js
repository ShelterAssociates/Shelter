...
function initMap(obj1, zoomlavel, flag=false) {
  if(!flag){
	 map = new google.maps.Map(document.getElementById('map12'), {
		zoom : zoomlavel,
		mapTypeId : 'satellite',
...
function loadslum() {
  ...
  $.ajax({
        ...
        obj[city_name] = {"content":{}, "lat":"", "id":1,"borderColor":"#94BBFF", "name":city_name,"bgColor":"#94BBFF"}
...
function createMap(jsondata, arrRemoveInd, flag=false) {
	var wdname = "";
	var wdadd = "";
	var head = "";
	compochk.html('');
