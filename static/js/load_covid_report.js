	...
	function load_report_covid(){
		...
		report_table_covid = $("#report_table_covid").DataTable({
			...
			"columns":[
						...
						{"data": "total_oc_hh", "title": "Occupied Households"},
						{"data": "total_sw_hh", "title": "Covid Surveyed household"},
						{"data": "pr", "title": "percentage(%)"},
						{"data": "total_hh_m", "title": "Total Surveyed HH Members"},
						{"data": "total_ppl_0_11", "title": "No. of people Below the age 12"},
						{"data": "total_ppl_btw_12_17", "title": "No. of people in 12 to 17 Age Group"},
						{"data": "1_dose_done_12_17", "title": "Only First Dose Taken(12-17)"},
						{"data": "2_dose_done_12_17", "title": "Both dose taken(12-17)"},
						{"data": "not_vaccinated_12_17", "title": "Not Vaccinated(12-17)"},
						{"data": "total_ppl_abv_17", "title": "No. of people Above the Age 17"},
						{"data": "1_dose_done_abv_17", "title": "1st dose taken(above 17)"},
						{"data": "2_dose_done_abv_17", "title": "2nd dose taken(above 17)"},
						{"data": "not_vaccinated_abv_18", "title": "Not Vaccinated(above 17)"},
