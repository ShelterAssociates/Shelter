...
def slum_created_trigger(sender, instance, **kwargs):
    ...
    conn = psycopg2.connect(
        database=settings.KOBOCAT_DATABASES["DBNAME"],
...
""",
        ...
        cursor.execute(
            "update logger_xform set json=%s, xml=%s where id=" + koboform_id,
            [(koboform_json,), (koboform_xml,)],
        )
...
def Rapid_Slum_Appraisal_created_trigger(sender, instance, **kwargs):
    ...
    try:
        ...
        try:
            if (
                this.waste_management_info_left_image.name
                != instance.waste_management_info_left_image.name
            ):
        ...
        try:
            if (
                this.general_info_left_image.name
                != instance.general_info_left_image.name
            ):
        ...
        try:
            if (
                this.roads_and_access_info_left_image.name
                != instance.roads_and_access_info_left_image.name
            ):
        ...
        try:
            if (
                this.drainage_info_left_image.name
                != instance.drainage_info_left_image.name
            ):
        ...
        try:
            if (
                this.general_image_bottomdown1.name
                != instance.general_image_bottomdown1.name
            ):
        ...
        try:
            if (
                this.general_image_bottomdown2.name
                != instance.general_image_bottomdown2.name
            ):
        ...
        try:
            if (
                this.toilet_image_bottomdown1.name
                != instance.toilet_image_bottomdown1.name
            ):
        ...
        try:
            if (
                this.toilet_image_bottomdown2.name
                != instance.toilet_image_bottomdown2.name
            ):
        ...
        try:
            if (
                this.waste_management_image_bottomdown1.name
                != instance.waste_management_image_bottomdown1.name
            ):
        ...
        try:
            if (
                this.waste_management_image_bottomdown2.name
                != instance.waste_management_image_bottomdown2.name
            ):
        ...
        try:
            if (
                this.water_image_bottomdown1.name
                != instance.water_image_bottomdown1.name
            ):
        ...
        try:
            if (
                this.water_image_bottomdown2.name
                != instance.water_image_bottomdown2.name
            ):
        ...
        try:
            if (
                this.roads_image_bottomdown1.name
                != instance.roads_image_bottomdown1.name
            ):
        ...
        try:
            if (
                this.roads_image_bottomdown2.name
                != instance.roads_image_bottomdown2.name
            ):
        ...
        try:
            if (
                this.drainage_image_bottomdown1.name
                != instance.drainage_image_bottomdown1.name
            ):
        ...
        try:
            if (
                this.drainage_image_bottomdown2.name
                != instance.drainage_image_bottomdown2.name
            ):
        ...
        try:
            if (
                this.gutter_image_bottomdown1.name
                != instance.gutter_image_bottomdown1.name
            ):
        ...
        try:
            if (
                this.gutter_image_bottomdown2.name
                != instance.gutter_image_bottomdown2.name
            ):
