...
sudo -H ./letsencrypt-auto certonly --standalone --renew-by-default -d app.shelter-associates.org -d report.shelter-associates.org -d graphs.shelter-associates.org
