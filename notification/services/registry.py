...
JOBS = {
    ...
    "household_encounter_sync": "avni.jobs.manual_sync:household_encounter_sync",
    "member_sync": "avni.jobs.manual_sync:member_sync",
    "subject_sync": "avni.jobs.manual_sync:subject_sync",
