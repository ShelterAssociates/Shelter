...
def create_ra_xml(options):
    ...
    for slum in survey_list:
        ...
        try:
            ...
            slum_fact = get_question_answer(
                qry_ra_survey_slum_question_answer
                % (survey_id, project_id, slum, survey_id, project_id, slum)
            )
            toilet_fact = get_toilet_question_answer(
                qry_ra_survey_toilet_question_answer % (survey_id, project_id, slum)
            )
            ...
            if slum_code:
                ...
                group_tb3th42_dict = copy.deepcopy(
                    ra_xml_dict["group_te3dx03"]["group_tb3th42"]
                )
                ...
                if date_of_survey:
                    ...
                    ra_xml_dict["group_ws5ux48"]["date_of_survey"] = get_formatted_data(
                        date_of_survey
                    )

                name_of_surveyor_s_who_checke = get_answer(
                    "name_of_surveyor_s_who_checke", fact
                )
                name_of_surveyor_1 = get_name_id(
                    "sf02f44", name_of_surveyor_s_who_checke
                )
                if name_of_surveyor_1 is None:
                    name_mismatch_records["name_of_surveyor_s_who_checke"]["count"] += 1
                    name_mismatch_records["name_of_surveyor_s_who_checke"][
                        "slum"
                    ].append(slum)
                else:
                    ra_xml_dict["group_ws5ux48"][
                        "name_of_surveyor_s_who_checke"
                    ] = name_of_surveyor_1

                name_of_surveyor_s_who_collec = get_answer(
                    "name_of_surveyor_s_who_collec", fact
                )
                name_of_surveyor_2 = get_name_id(
                    "qs59t66", name_of_surveyor_s_who_collec
                )
                if name_of_surveyor_2 is None:
                    name_mismatch_records["name_of_surveyor_s_who_collec"]["count"] += 1
                    name_mismatch_records["name_of_surveyor_s_who_collec"][
                        "slum"
                    ].append(slum)
                else:
                    ra_xml_dict["group_ws5ux48"][
                        "name_of_surveyor_s_who_collec"
                    ] = name_of_surveyor_2

                name_of_surveyor_s_who_took_t = get_answer(
                    "name_of_surveyor_s_who_took_t", fact
                )
                name_of_surveyor_3 = get_name_id(
                    "gf4ac05", name_of_surveyor_s_who_took_t
                )
                if name_of_surveyor_3 is None:
                    name_mismatch_records["name_of_surveyor_s_who_took_t"]["count"] += 1
                    name_mismatch_records["name_of_surveyor_s_who_took_t"][
                        "slum"
                    ].append(slum)
                else:
                    ra_xml_dict["group_ws5ux48"][
                        "name_of_surveyor_s_who_took_t"
                    ] = name_of_surveyor_3
                ...
                ra_xml_dict["group_zl6oo94"]["group_uj8eg07"][
                    "survey_sector_number"
                ] = get_answer("survey_sector_number", fact)
                ra_xml_dict["group_zl6oo94"]["group_uj8eg07"]["landmark"] = get_answer(
                    "landmark", fact
                )
                ...
                ra_xml_dict["group_zl6oo94"]["group_wb1hp47"][
                    "year_established_according_to"
                ] = get_answer("year_established_according_to", fact)
                ...
                if legal_status:
                    ...
                    if legal_status != "01":
                        ra_xml_dict["group_zl6oo94"]["group_wb1hp47"][
                            "Date_of_declaration"
                        ] = get_answer("Date_of_declaration", fact)
                    # else:
                    # del ra_xml_dict['group_zl6oo94']['group_wb1hp47']['Date_of_declaration']
                ...
                development_plan_reservation_t = get_answer(
                    "development_plan_reservation_t", fact
                )
                if development_plan_reservation_t:
                    ra_xml_dict["group_zl6oo94"]["group_wb1hp47"][
                        "development_plan_reservation_t"
                    ] = development_plan_reservation_t

                ra_xml_dict["group_zl6oo94"]["group_wb1hp47"][
                    "development_plan_reservation"
                ] = get_answer("development_plan_reservation", fact)

                approximate_area_of_the_settle = get_answer(
                    "approximate_area_of_the_settle", fact
                )
                ra_xml_dict["group_zl6oo94"]["group_wb1hp47"][
                    "approximate_area_of_the_settle"
                ] = convert_area_from_square_meters(approximate_area_of_the_settle)

                number_of_huts_in_settlement = get_approximat_huts(
                    slum, get_answer("number_of_huts_in_settlement", fact)
                )
                ra_xml_dict["group_zl6oo94"]["group_wb1hp47"][
                    "number_of_huts_in_settlement"
                ] = number_of_huts_in_settlement
                ...
                ra_xml_dict["group_zl6oo94"]["group_wb1hp47"]["describe_the_slum"] = (
                    get_answer("describe_the_slum", fact)
                )
                ...
                if status_of_defecation:
                    ra_xml_dict["group_te3dx03"]["group_ul75r92"][
                        "status_of_defecation"
                    ] = status_of_defecation

                number_of_community_toilet_blo = get_answer(
                    "number_of_community_toilet_blo", fact
                )
                ra_xml_dict["group_te3dx03"]["group_ul75r92"][
                ...
                if (
                    number_of_community_toilet_blo
                    and int(number_of_community_toilet_blo) > 0
                ):
                    ...
                    ] = int(get_answer("number_of_pay_and_use_CTBs", fact))
                    ...
                    for toilet_id in toilet_fact.keys():
                        ...
                        is_the_CTB_in_use = get_answer(
                            "is_the_CTB_in_use", toilet_fact[toilet_id]
                        )
                        if is_the_CTB_in_use:
                            toilet_details_dict["is_the_CTB_in_use"] = is_the_CTB_in_use

                            if is_the_CTB_in_use == "04":
                                toilet_details_dict["fee_for_use_of_ctb_per_family"] = (
                                    int(
                                        get_answer(
                                            "fee_for_use_of_ctb_per_family",
                                            toilet_fact[toilet_id],
                                        )
                                    )
                                )
                                toilet_details_dict["cost_of_pay_and_use_toilet_pe"] = (
                                    int(
                                        get_answer(
                                            "cost_of_pay_and_use_toilet_pe",
                                            toilet_fact[toilet_id],
                                        )
                                    )
                                )
                                toilet_details_dict["ctb_gender_usage"] = get_answer(
                                    "ctb_gender_usage", toilet_fact[toilet_id]
                                )

                                ctb_gender_usage = get_answer(
                                    "ctb_gender_usage", toilet_fact[toilet_id]
                                )
                                if ctb_gender_usage:
                                    if ctb_gender_usage == "03":
                                        toilet_details_dict[
                                            "total_number_of_mixed_seats_al"
                                        ] = 0  # get_answer('total_number_of_mixed_seats_al', toilet_fact[toilet_id])

                                        number_of_mixed_seats_allotted = get_answer(
                                            "number_of_mixed_seats_allotted",
                                            toilet_fact[toilet_id],
                                        )
                                        toilet_details_dict[
                                            "number_of_mixed_seats_allotted"
                                        ] = 0  # get_answer('number_of_mixed_seats_allotted', toilet_fact[toilet_id])
                                        ...
                                        ctb_gender_usage == "01"
                                        or ctb_gender_usage == "04"
                                    ):
                                        toilet_details_dict[
                                            "number_of_seats_allotted_to_me"
                                        ] = int(
                                            get_answer(
                                                "number_of_seats_allotted_to_me",
                                                toilet_fact[toilet_id],
                                        ...
                                        number_of_seats_allotted_to_me_001 = get_answer(
                                            "number_of_seats_allotted_to_me_001",
                                            toilet_fact[toilet_id],
                                        )
                                        toilet_details_dict[
                                            "number_of_seats_allotted_to_me_001"
                                        ] = int(number_of_seats_allotted_to_me_001)

                                        if int(number_of_seats_allotted_to_me_001) > 0:
                                            the_reason_for_men_not_using_t = get_answer(
                                                "the_reason_for_men_not_using_t",
                                                toilet_fact[toilet_id],
                                            )
                                        ...
                                        toilet_details_dict[
                                            "number_of_seats_allotted_to_wo"
                                        ] = int(
                                            get_answer(
                                                "number_of_seats_allotted_to_wo",
                                                toilet_fact[toilet_id],
                                        ...
                                        number_of_seats_allotted_to_wo_001 = get_answer(
                                            "number_of_seats_allotted_to_wo_001",
                                            toilet_fact[toilet_id],
                                        )
                                        toilet_details_dict[
                                            "number_of_seats_allotted_to_wo_001"
                                        ] = int(number_of_seats_allotted_to_wo_001)

                                        if int(number_of_seats_allotted_to_wo_001) > 0:
                                            the_reason_for_women_not_using = get_answer(
                                                "the_reason_for_women_not_using",
                                                toilet_fact[toilet_id],
                                            )
                                ...
                                is_the_ctb_available_at_night = get_answer(
                                    "is_the_ctb_available_at_night",
                                    toilet_fact[toilet_id],
                                )
                                ...
                                ctb_maintenance_provided_by = get_answer(
                                ...
                                condition_of_ctb_structure = get_answer(
                                    "condition_of_ctb_structure", toilet_fact[toilet_id]
                                )
                                ...
                                toilet_details_dict[
                                    "out_of_total_seats_no_of_pans_in_good_condition"
                                ] = None  # get_answer('out_of_total_seats_no_of_pans_in_good_condition', toilet_fact[toilet_id])
                                toilet_details_dict[
                                    "out_of_total_seats_no_of_doors_in_good_condition"
                                ] = None  # get_answer('out_of_total_seats_no_of_doors_in_good_condition', toilet_fact[toilet_id])
                                toilet_details_dict[
                                    "out_of_total_seats_no_of_seats_where_electricity_is_available"
                                ] = None  # get_answer('out_of_total_seats_no_of_seats_where_electricity_is_available', toilet_fact[toilet_id])
                                toilet_details_dict[
                                    "out_of_total_seats_no_of_seats_where_tiles_on_wall_are_in_good_condition"
                                ] = None  # get_answer('out_of_total_seats_no_of_seats_where_tiles_on_wall_are_in_good_condition', toilet_fact[toilet_id])
                                toilet_details_dict[
                                    "out_of_total_seats_no_of_seats_where_tiles_on_floor_are_in_good_condition"
                                ] = None  # get_answer('out_of_total_seats_no_of_seats_where_tiles_on_floor_are_in_good_condition', toilet_fact[toilet_id])

                                frequency_of_ctb_cleaning_by_U = get_answer(
                                    "frequency_of_ctb_cleaning_by_U",
                                    toilet_fact[toilet_id],
                                )
                                ...
                                does_the_ulb_ngo_communty_use = get_answer(
                                    "does_the_ulb_ngo_communty_use",
                                    toilet_fact[toilet_id],
                                )
                                ...
                                cleanliness_of_the_ctb = get_answer(
                                    "cleanliness_of_the_ctb", toilet_fact[toilet_id]
                                )
                                if cleanliness_of_the_ctb:
                                    toilet_details_dict["cleanliness_of_the_ctb"] = (
                                        cleanliness_of_the_ctb
                                    )

                                is_there_a_caretaker_for_the_C = get_answer(
                                    "is_there_a_caretaker_for_the_C",
                                    toilet_fact[toilet_id],
                                )
                                if is_there_a_caretaker_for_the_C:
                                    toilet_details_dict[
                                        "is_there_a_cretaker_for_the_C"
                                    ] = is_there_a_caretaker_for_the_C

                                type_of_water_supply_in_ctb = get_answer(
                                    "type_of_water_supply_in_ctb",
                                    toilet_fact[toilet_id],
                                )
                                if type_of_water_supply_in_ctb:
                                    ...
                                    if type_of_water_supply_in_ctb == "02":
                                        capacity_of_ctb_water_tank_in = get_answer(
                                            "capacity_of_ctb_water_tank_in",
                                            toilet_fact[toilet_id],
                                        )
                                ...
                                litres_of_water_used_by_commun = get_answer(
                                    "litres_of_water_used_by_commun",
                                    toilet_fact[toilet_id],
                                )
                                ...
                                availability_of_water_in_the_t = get_answer(
                                    "availability_of_water_in_the_t",
                                    toilet_fact[toilet_id],
                                )
                                ...
                                availability_of_electricity_in = get_answer(
                                    "availability_of_electricity_in",
                                    toilet_fact[toilet_id],
                                )
                                ...
                                availability_of_electricity_in_001 = get_answer(
                                    "availability_of_electricity_in_001",
                                    toilet_fact[toilet_id],
                                )
                                ...
                                facility_in_the_toilet_block_f = get_answer(
                                ...
                                if facility_in_the_toilet_block_f:
                                    ...
                                    if facility_in_the_toilet_block_f == "02":
                                        condition_of_facility_for_chil = get_answer(
                                            "condition_of_facility_for_chil",
                                            toilet_fact[toilet_id],
                                        )
                                ...
                                sewage_disposal_system = get_answer(
                                    "sewage_disposal_system", toilet_fact[toilet_id]
                                )
                                if sewage_disposal_system:
                                    toilet_details_dict["sewage_disposal_system"] = (
                                        sewage_disposal_system
                                    )

                                distance_to_nearest_ulb_sewer = get_answer(
                                    "distance_to_nearest_ulb_sewer",
                                    toilet_fact[toilet_id],
                                )
                    ...
                    del ra_xml_dict["group_te3dx03"]["group_ul75r92"][
                        "number_of_pay_and_use_CTBs"
                    ]

                ra_xml_dict["group_te3dx03"]["toilet_comment"] = get_answer(
                    "toilet_comment", fact
                )
                ...
                # Water Information
                Total_number_of_standposts_in_ = get_answer(
                    "Total_number_of_standposts_in_", fact
                )

                if Total_number_of_standposts_in_:
                    ra_xml_dict["group_zj8tc43"]["Total_number_of_standposts_in_"] = (
                        int(Total_number_of_standposts_in_)
                    )

                    if int(Total_number_of_standposts_in_) > 0:
                        ra_xml_dict["group_zj8tc43"][
                            "total_number_of_taps_in_use_n"
                        ] = get_answer("total_number_of_taps_in_use_n", fact)

                Total_number_of_standposts_NOT = get_answer(
                    "Total_number_of_standposts_NOT", fact
                )
                ...
                if Total_number_of_standposts_NOT:
                    ...
                    if (
                        not (Total_number_of_standposts_in_ is None)
                        and int(Total_number_of_standposts_in_) > 0
                    ) or int(Total_number_of_standposts_NOT) > 0:
                        ra_xml_dict["group_zj8tc43"][
                            "total_number_of_taps_in_use_n_001"
                        ] = get_answer("total_number_of_taps_in_use_n_001", fact)

                total_number_of_handpumps_in_u = get_answer(
                    "total_number_of_handpumps_in_u", fact
                )
                ra_xml_dict["group_zj8tc43"]["total_number_of_handpumps_in_u"] = (
                    int(total_number_of_handpumps_in_u)
                    if total_number_of_handpumps_in_u
                    else 0
                )

                total_number_of_handpumps_in_u_001 = get_answer(
                    "total_number_of_handpumps_in_u_001", fact
                )
                ra_xml_dict["group_zj8tc43"]["total_number_of_handpumps_in_u_001"] = (
                    int(total_number_of_handpumps_in_u_001)
                    if total_number_of_handpumps_in_u_001
                    else 0
                )

                alternative_source_of_water = get_answer(
                    "alternative_source_of_water", fact
                )
                if alternative_source_of_water:
                    ra_xml_dict["group_zj8tc43"][
                        "alternative_source_of_water"
                    ] = alternative_source_of_water
                ...
                pressure_of_water_in_the_syste = get_answer(
                    "pressure_of_water_in_the_syste", fact
                )
                ...
                coverage_of_wateracross_settle = get_answer(
                    "coverage_of_wateracross_settle", fact
                )
                if coverage_of_wateracross_settle:
                    ra_xml_dict["group_zj8tc43"][
                        "coverage_of_wateracross_settle"
                    ] = coverage_of_wateracross_settle

                quality_of_water_in_the_system = get_answer(
                    "quality_of_water_in_the_system", fact
                )
                if quality_of_water_in_the_system:
                    ra_xml_dict["group_zj8tc43"][
                        "quality_of_water_in_the_system"
                    ] = quality_of_water_in_the_system

                ra_xml_dict["group_zj8tc43"]["water_supply_comment"] = get_answer(
                    "water_supply_comment", fact
                )
                ...
                total_number_of_waste_containe = get_answer(
                    "total_number_of_waste_containe", fact
                )
                ra_xml_dict["group_ks0wh10"]["total_number_of_waste_containe"] = (
                    int(total_number_of_waste_containe)
                    if total_number_of_waste_containe
                    else 0
                )

                facility_of_waste_collection = get_answer(
                    "facility_of_waste_collection", fact
                )
                if facility_of_waste_collection:
                    ra_xml_dict["group_ks0wh10"][
                ...
                where_are_the_communty_open_du = get_answer(
                    "where_are_the_communty_open_du", fact
                )
                if where_are_the_communty_open_du:
                    ra_xml_dict["group_ks0wh10"][
                        "where_are_the_communty_open_du"
                    ] = where_are_the_communty_open_du

                do_the_member_of_community_dep = get_answer(
                    "do_the_member_of_community_dep", fact
                )
                if do_the_member_of_community_dep:
                    ra_xml_dict["group_ks0wh10"][
                        "do_the_member_of_community_dep"
                    ] = do_the_member_of_community_dep

                ra_xml_dict["group_ks0wh10"]["Waste_management_comments"] = get_answer(
                    "Waste_management_comments", fact
                )
                ...
                presence_of_drains_within_the = get_answer(
                    "presence_of_drains_within_the", fact
                )
                if presence_of_drains_within_the:
                    ra_xml_dict["group_kk5gz02"][
                        "presence_of_drains_within_the"
                    ] = presence_of_drains_within_the

                    if presence_of_drains_within_the == "02":
                        coverage_of_drains_across_the = get_answer(
                            "coverage_of_drains_across_the", fact
                        )
                        if coverage_of_drains_across_the:
                            ra_xml_dict["group_kk5gz02"][
                                "coverage_of_drains_across_the"
                            ] = coverage_of_drains_across_the

                        do_the_drains_get_blocked = get_answer(
                            "do_the_drains_get_blocked", fact
                        )
                        if do_the_drains_get_blocked:
                            ra_xml_dict["group_kk5gz02"][
                                "do_the_drains_get_blocked"
                            ] = do_the_drains_get_blocked

                        is_the_drainage_gradient_adequ = get_answer(
                            "is_the_drainage_gradient_adequ", fact
                        )
                        if is_the_drainage_gradient_adequ:
                            ra_xml_dict["group_kk5gz02"][
                                "is_the_drainage_gradient_adequ"
                            ] = is_the_drainage_gradient_adequ

                        # ra_xml_dict['group_kk5gz02']['diameter_of_ulb_sewer_line_acr'] = None #get_answer('diameter_of_ulb_sewer_line_acr', fact)

                ra_xml_dict["group_kk5gz02"]["drainage_comment"] = get_answer(
                    "drainage_comment", fact
                )
                ...
                if Presence_of_gutter:
                    ra_xml_dict["group_bv7hf31"][
                        "Presence_of_gutter"
                    ] = Presence_of_gutter

                    if Presence_of_gutter == "02":
                        ra_xml_dict["group_bv7hf31"][
                            "type_of_gutter_within_the_sett"
                        ] = get_answer("type_of_gutter_within_the_sett", fact)
                        ra_xml_dict["group_bv7hf31"]["coverage_of_gutter"] = get_answer(
                            "coverage_of_gutter", fact
                        )
                        ra_xml_dict["group_bv7hf31"]["are_gutter_covered"] = get_answer(
                            "are_gutter_covered", fact
                        )
                        ra_xml_dict["group_bv7hf31"]["do_gutters_flood"] = get_answer(
                            "do_gutters_flood", fact
                        )
                        ra_xml_dict["group_bv7hf31"]["do_gutter_get_choked"] = (
                            get_answer("do_gutter_get_choked", fact)
                        )
                        ra_xml_dict["group_bv7hf31"]["is_gutter_gradient_adequate"] = (
                            get_answer("is_gutter_gradient_adequate", fact)
                        )

                ra_xml_dict["group_bv7hf31"]["comments_on_gutter"] = get_answer(
                    "comments_on_gutter", fact
                )
                ...
                presence_of_roads_within_the_s = get_answer(
                    "presence_of_roads_within_the_s", fact
                )
                if presence_of_roads_within_the_s:
                    ra_xml_dict["group_xy9hz30"][
                        "presence_of_roads_within_the_s"
                    ] = presence_of_roads_within_the_s

                    if presence_of_roads_within_the_s == "02":
                        type_of_roads_within_the_settl = get_answer(
                            "type_of_roads_within_the_settl", fact
                        )
                        if type_of_roads_within_the_settl:
                            ...
                            if type_of_roads_within_the_settl == "03":
                                coverage_of_pucca_road_across = get_answer(
                                    "coverage_of_pucca_road_across", fact
                                )
                                if coverage_of_pucca_road_across:
                                    ra_xml_dict["group_xy9hz30"][
                                        "coverage_of_pucca_road_across"
                                    ] = coverage_of_pucca_road_across
                        ...
                        average_width_of_internal_road = get_answer(
                            "average_width_of_internal_road", fact
                        )
                        ...
                        average_width_of_arterial_road = get_answer(
                            "average_width_of_arterial_road", fact
                        )
                        if average_width_of_arterial_road:
                            ra_xml_dict["group_xy9hz30"][
                                "average_width_of_arterial_road"
                            ] = average_width_of_arterial_road

                        point_of_vehicular_access_to_t = get_answer(
                            "point_of_vehicular_access_to_t", fact
                        )
                        if point_of_vehicular_access_to_t:
                            ra_xml_dict["group_xy9hz30"][
                                "point_of_vehicular_access_to_t"
                            ] = point_of_vehicular_access_to_t

                        is_the_settlement_below_or_abo = get_answer(
                            "is_the_settlement_below_or_abo", fact
                        )
                        if is_the_settlement_below_or_abo:
                            ra_xml_dict["group_xy9hz30"][
                                "is_the_settlement_below_or_abo"
                            ] = is_the_settlement_below_or_abo

                        are_the_huts_below_or_above_th = get_answer(
                            "are_the_huts_below_or_above_th", fact
                        )
                        if are_the_huts_below_or_above_th:
                            ra_xml_dict["group_xy9hz30"][
                                "are_the_huts_below_or_above_th"
                            ] = are_the_huts_below_or_above_th

                ra_xml_dict["group_xy9hz30"]["road_and_access_comment"] = get_answer(
                    "road_and_access_comment", fact
                )
                ...
                repeat_dict = {
                    "group_te3dx03": {"append_index": 1, "list": toilet_info}
                }
                xml_root_string = create_xml_string(
                    ra_xml_dict,
                    repeat_dict,
                    xml_root,
                    xml_root_attr_id,
            ...
            exception_log = (
                "Exception occurred for slum id "
                + str(slum)
                + " \t  exception : "
                + str(ex)
                + " \t  traceback : "
