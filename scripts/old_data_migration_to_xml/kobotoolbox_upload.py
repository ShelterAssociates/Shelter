...
def upload_xml(upload_option):
    ...
    try:
        ...
        response_obj = requests.post(
            kobotoolbox_url,
            auth=(kobotoolbox_user, kobotoolbox_password),
            files=upload_files,
        )
        ...
        exception_log = (
            "Exception occurred for uploading xml file \t  exception : "
            + str(ex)
            + " \t  traceback : "
                ...
                upload_option.append(
                    {
                        ...
                        "xml_photo": get_xml_photo_value(
                            dirpath, filename, xml_photo_element_name
                        ),
                    }
                )
