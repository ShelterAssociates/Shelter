        ...
        for house in sponsored_household.household_code:
            ...
            if house in records:
                ...
                if 'group_ye18c77/group_yw8pj39/Current_place_of_defecation_toilet' in record and record['group_ye18c77/group_yw8pj39/Current_place_of_defecation_toilet'] in ['01', '02']:
                    ...
                    create_data = pcmc_rhs_xml_create(record)
                    ...
                    if status:
                        ...
                        file_name = 'RHS_Survey_Slum_Id_' + str(slum) + '_House_code_' + str(house)
                        folder_path = os.path.join(output_folder_path, "slum_" + str(slum))
...
def pcmc_rhs_xml_create(record):
...
def pcmc_rhs_xml_replace(record):
    flag=False
    if record['group_ce0hf58']['Type_of_structure_occupancy'] == '01' :
        record['group_ye18c77']['group_yw8pj39']['Current_place_of_defecation_toilet'] = "03"
        record['meta']['deprecatedID'] = record['meta']['instanceID']
        record['meta']['instanceID'] = 'uuid:' + str(uuid.uuid4())
        flag = True
    else:
        flag = False
        print "ERROR"
