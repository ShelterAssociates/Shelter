...
def queryToFetchRecords(kobo_survey):
    ...
    for record in json_records:
        if 'group_ye18c77/group_yw8pj39/what_is_the_structure_of_the_house' in record and record[
            'group_ye18c77/group_yw8pj39/what_is_the_structure_of_the_house'] != "":
        ...
        for key, val in v.iteritems():
            ...
            for record_sort in record_sorted:
                if 'group_ce0hf58/Type_of_structure_occupancy' in record_sort:
                    if record_sort['group_ce0hf58/Type_of_structure_occupancy'] == "01" or (
                            record_sort['group_ce0hf58/Type_of_structure_occupancy'] != "01" and flag):
                        flag = False
                        record = record_sort
                        ...
                        if status:
                            xml_string = create_xml_string(replace_data, [], replace_data['_xform_id_string'],
                                                           replace_data['_xform_id_string'],
                                                           replace_data['__version__'])
                            file_name = 'RHS_Survey_Slum_Id_' + str(slum_code.replace('/', '')) + '_House_code_' + str(
                                key) + '_' + str(record['_id'])
...
def kmc_rhs_xml_replace(rhs_record, record):
    ...
    if record['group_ce0hf58/Type_of_structure_occupancy'] in ["03", "04", "05", "06", "07"]:
        ...
        rhs_record['Type_of_structure_occupancy'] = "03" if record[
                                                                'group_ce0hf58/Type_of_structure_occupancy'] == "02" else "01"

    if rhs_record['Type_of_unoccupied_house'] and rhs_record[
        'Type_of_unoccupied_house'] == "021" and 'group_ye18c77/group_ud4em45/what_is_the_full_name_of_the_family_head_' in record:

        parent_house = (
        record['group_ye18c77/group_ud4em45/what_is_the_full_name_of_the_family_head_'].strip())  # .split(' ')
    ...
    if rhs_record['Type_of_structure_occupancy'] == "01":
        ...
        if rhs_record['group_el9cl08']['Do_you_have_any_girl_child_chi'] == "02" and rhs_record['group_el9cl08'][
            'How_many'] and int(
                rhs_record['group_el9cl08']['How_many']) > 0:
        ...
        if 'group_ye18c77/group_yw8pj39/facility_of_waste_collection' in record and len(
                record['group_ye18c77/group_yw8pj39/facility_of_waste_collection'].split(' ')) > 0:
            ...
            rhs_record['group_el9cl08']['Facility_of_solid_waste_collection'] = FACILITY_OF_SOLID_WASTE[
                record['group_ye18c77/group_yw8pj39/facility_of_waste_collection'].split(' ')[
                    0]]  # ' '.join(waste_facility)
        ...
        if rhs_record['group_oi8ts04']['Have_you_applied_for_individua'] == "01":
            if rhs_record['group_oi8ts04']['How_many_installments_have_you'] == "01":
                ...
                if not rhs_record['group_oi8ts04']['Status_of_toilet_under_SBM']:
                    if rhs_record['group_oi8ts04']['Current_place_of_defecation'] == "05":
                        ...
                        rhs_record['group_oi8ts04']['Type_of_SBM_toilets'] = None
                        rhs_record['group_oi8ts04']['How_many_installments_have_you'] = None
                        rhs_record['group_oi8ts04']['C2'] = rhs_record['group_oi8ts04']['Current_place_of_defecation']
                    ...
                    if rhs_record['group_oi8ts04']['Current_place_of_defecation'] in ["09","10"]:
                        ...
                        rhs_record['group_oi8ts04']['C5'] = rhs_record['group_oi8ts04']['Current_place_of_defecation']

                if rhs_record['group_oi8ts04']['Status_of_toilet_under_SBM'] in ["03","04","05"]:
                    if rhs_record['group_oi8ts04']['Current_place_of_defecation'] in ["09","10", "11","12"]:
                        rhs_record['group_oi8ts04']['Status_of_toilet_under_SBM'] = "05"
                        rhs_record['group_oi8ts04']['C5'] = rhs_record['group_oi8ts04']['Current_place_of_defecation']
                        rhs_record['group_oi8ts04']['C4'] = None
            ...
            if rhs_record['group_oi8ts04']['How_many_installments_have_you'] == "02":
                if not rhs_record['group_oi8ts04']['When_did_you_receive_ur_first_installment']:
                    if rhs_record['group_oi8ts04']['Current_place_of_defecation'] == "05":
                        rhs_record['group_oi8ts04']['Have_you_applied_for_individua'] = "03"
                        rhs_record['group_oi8ts04']['Type_of_SBM_toilets'] = None
                        rhs_record['group_oi8ts04']['How_many_installments_have_you'] = None
                    ...
                    if rhs_record['group_oi8ts04']['Current_place_of_defecation'] in  ["09","10"]:
                        ...
                        if not rhs_record['group_oi8ts04']['Are_you_interested_in_an_indiv'] :
                            ...
                            rhs_record['group_oi8ts04']['If_no_why'] = "08"
                            rhs_record['group_oi8ts04']['What_is_the_toilet_connected_to'] = None
                if rhs_record['group_oi8ts04']['When_did_you_receive_ur_first_installment']:
                    if rhs_record['group_oi8ts04']['Status_of_toilet_under_SBM'] == "01":
                        rhs_record['group_oi8ts04']['Are_you_interested_in_an_indiv'] = None
                        rhs_record['group_oi8ts04']['If_no_why'] = None
                        rhs_record['group_oi8ts04']['If_yes_why'] = None
                    ...
                    if rhs_record['group_oi8ts04']['Status_of_toilet_under_SBM'] == "05":
                        rhs_record['group_oi8ts04']['C4'] = rhs_record['group_oi8ts04']['Current_place_of_defecation']
            ...
            if rhs_record['group_oi8ts04']['How_many_installments_have_you'] == "03":
                if rhs_record['group_oi8ts04']['When_did_you_receive_r_second_installment'] and rhs_record['group_oi8ts04']['When_did_you_receive_ur_first_installment']:
                    if rhs_record['group_oi8ts04']['Status_of_toilet_under_SBM'] == "01":
                        rhs_record['group_oi8ts04']['Are_you_interested_in_an_indiv'] = None
                        rhs_record['group_oi8ts04']['If_no_why'] = None
                        rhs_record['group_oi8ts04']['If_yes_why'] = None
