...
# Live #vs8xz9gnxNF4b86uUskez8 #001d0a70aeb14b9ea4658dbca7818e3f #RHS_SBM_TMC_v1
...
def kmc_rhs_xml_replace(rhs_record, record):
    ...
    if rhs_record["Type_of_structure_occupancy"] == "01":
        ...
        if (
            rhs_record["group_oi8ts04"]["Are_you_interested_in_an_indiv"] == "01"
            and not rhs_record["group_oi8ts04"]["What_kind_of_toilet_would_you_like"]
        ):
