...
POINT = ['GarbageBins', 'OpenGarbage', 'Manhole']
POLYGON = ['OpenDefecationArea', 'Community Toilet Block', 'Houses']
LINESTRING = ['TarRoad', 'Coba', 'Drainage Line 18inch', 'Drainage Line 12inch', 'Drainage Line 10inch']
...
class KMLParser(object):
    ...
    metadata_component = {  'Houses' : 1, 'Community Toilet Block': 2, 'OpenDefecationArea': 3,
                            ...
                            'Drainage Line 18inch':10, 'Coba': 11
                            }
