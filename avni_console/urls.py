...
urlpatterns = [
    ...
    url(r"^runs/(?P<pk>[0-9]+)/retry/$", views.run_retry, name="run_retry"),
    ...
    url(r"^subjects/$", views.subject_explorer, name="subjects"),
    url(r"^subjects/preview/$", views.subject_preview, name="subject_preview"),
    url(r"^subjects/sync/$", views.subject_sync_queue, name="subject_sync_queue"),
]
